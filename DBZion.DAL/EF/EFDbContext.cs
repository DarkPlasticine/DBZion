...
namespace DBZion.DAL.EF
{
    ...
    class MyEFDbInitializer : DropCreateDatabaseIfModelChanges<EFDbContext>
    {
        protected override void Seed(EFDbContext context)
        {
            ...
            Order order2 = new Order(2, "Картридж", "Ремонт", 2500, datetime2, "Описание", "Заметка", false, false, false, user2, "Вазген");
            Order order3 = new Order(3, @"Тест Б/У", "Ремонт", 666, datetime3, "Описание", "Заметка", false, false, false, user3, "Короед");
